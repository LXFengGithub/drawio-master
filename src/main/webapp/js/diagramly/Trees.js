	...
	if (typeof Sidebar !== 'undefined')
	{
		...
		Sidebar.prototype.createAdvancedShapes = function()
		{
			...
			return result.concat([
				...
				{
					var cell = new mxCell('树容器', new mxGeometry(0, 0, 400, 320),
				...
				{
					var mindmap = new mxCell('思维导图', new mxGeometry(0, 0, 420, 126),
						'swimlane;html=1;startSize=20;horizontal=1;containerType=tree;');
					mindmap.vertex = true;

					var cell = new mxCell('中心思想', new mxGeometry(160, 60, 100, 40),
				    	'ellipse;whiteSpace=wrap;html=1;align=center;' +
				    	'treeFolding=1;treeMoving=1;' + mmEdgeStyle);
			    	cell.vertex = true;

			    	var cell2 = new mxCell('主题', new mxGeometry(320, 40, 80, 20),
			    	...
			    	var cell3 = new mxCell('分支', new mxGeometry(320, 80, 72, 26),
			    	...
			    	var cell4 = new mxCell('主题', new mxGeometry(20, 40, 80, 20),
				    	'whiteSpace=wrap;html=1;rounded=1;arcSize=50;align=center;verticalAlign=middle;' +
		    			'strokeWidth=1;autosize=1;spacing=4;treeFolding=1;treeMoving=1;' + mmEdgeStyle);
			    	cell4.vertex = true;
			    	...
			    	var cell5 = new mxCell('分支', new mxGeometry(20, 80, 72, 26),
			    		'whiteSpace=wrap;html=1;shape=partialRectangle;top=0;left=0;bottom=1;right=0;points=[[0,1],[1,1]];' +
			    		'fillColor=none;align=center;verticalAlign=bottom;routingCenterY=0.5;' +
			    		'snapToPoint=1;autosize=1;treeFolding=1;treeMoving=1;' + mmEdgeStyle);
			    	cell5.vertex = true;
				...
				{
					var cell = new mxCell('中心思想', new mxGeometry(0, 0, 100, 40),
				...
				{
			    	var cell = new mxCell('分支', new mxGeometry(0, 0, 80, 20),
			    		'whiteSpace=wrap;html=1;shape=partialRectangle;top=0;left=0;bottom=1;right=0;points=[[0,1],[1,1]];' +
			    		'fillColor=none;align=center;verticalAlign=bottom;routingCenterY=0.5;' +
				...
				{
			   		var cell = new mxCell('子主题', new mxGeometry(0, 0, 72, 26),
			    		'whiteSpace=wrap;html=1;rounded=1;arcSize=50;align=center;verticalAlign=middle;' +
			    		'strokeWidth=1;autosize=1;spacing=4;treeFolding=1;treeMoving=1;' + mmEdgeStyle);
			    	cell.vertex = true;
				...
				{
					var orgchart = new mxCell('组织机构图', new mxGeometry(0, 0, 280, 220),
				...
				{
			    	var cell = new mxCell('组织', new mxGeometry(0, 0, 120, 60),
			    		'whiteSpace=wrap;html=1;align=center;treeFolding=1;treeMoving=1;' + treeEdgeStyle);
				    graph.setAttributeForCell(cell, 'treeRoot', '1');
			    	cell.vertex = true;
				...
				{
		    		var cell = new mxCell('部门', new mxGeometry(20, 40, 100, 60),
			    		'whiteSpace=wrap;html=1;align=center;verticalAlign=middle;treeFolding=1;treeMoving=1;' + treeEdgeStyle);
			    	cell.vertex = true;
				...
				this.addEntry('tree sub sections', function()
				{
					...
					cell2.insertEdge(edge2, false);
				    	...
				    	return sb.createVertexTemplateFromCells([edge, edge2, cell, cell2], 220, 60, '子部门');
				})
			]);
		};
	}
