(function()
{
	...
	Sidebar.prototype.createAdvancedShapes = function()
	{
		...
		[
			...
			this.addDataEntry('vertical tree layout', 280, 190, '垂直树布局',
			...
			this.addDataEntry('horizontal tree layout', 310, 160, '水平树布局',
			...
			{
		 		return sb.createVertexTemplateFromCells([flow], flow.geometry.width, flow.geometry.height, '垂直流布局', true);
		 	}),
		 	this.addEntry('horizontal flow layout', function()
			{
				...
				return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '水平流布局', true);
			})
		]);
