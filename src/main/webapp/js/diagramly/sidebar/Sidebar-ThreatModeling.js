(function()
{
	Sidebar.prototype.addThreatModelingPalette = function()
	{
		...
		[
			...
			this.createVertexTemplateEntry('shape=note;strokeWidth=2;fontSize=14;size=20;whiteSpace=wrap;html=1;fillColor=#fff2cc;strokeColor=#d6b656;fontColor=#666600;', w * 1.1, h * 0.8, 'Note', 'Note', null, 'Note', this.getTagsForStencil(gn, 'note', dt).join(' ')),
