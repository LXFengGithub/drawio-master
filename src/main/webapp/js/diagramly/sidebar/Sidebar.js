(function()
{
	...
	Sidebar.prototype.configuration = [{id: 'general', libs: ['general', 'misc', 'advanced']},
									   {id: 'uml', prefix: 'uml', libs: [''/*prefix is library*/, 'UseCaseDiagram', 'SequenceChart','ClassDiagram','StateDiagram','DeploymentDiagram','ComponentDiagram']}, {id: 'uml25'}, {id: 'search'}, {id: 'er'},
